    ...
    return (
        <div className="kitchen-display" style={{ padding: '1rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '1.5rem' }}>
                ...
                {orders.map(order => (
                    <div key={order._id} className="card order-card" style={{
                        borderLeft: `5px solid ${order.orderStatus === 'pending' ? 'orange' :
                                order.orderStatus === 'confirmed' ? 'blue' : 'green'
                            }`
                    }}>
                        ...
                        {order.orderNotes && (
                            <div style={{ background: '#fff3cd', padding: '0.5rem', borderRadius: '4px', marginBottom: '1rem', fontSize: '0.9rem' }}>
